...
def main():
    ...
    setup_cmd = """
    su - postgres -c "psql -c 'DROP DATABASE IF EXISTS veo3web;'"
    su - postgres -c "psql -c 'DROP USER IF EXISTS veo3;'"
    su - postgres -c "psql -c \\"CREATE USER veo3 WITH PASSWORD 'iouX-4LBGcp_GxVGdjWYOcxF';\\""
    su - postgres -c "psql -c 'CREATE DATABASE veo3web OWNER veo3;'"
    su - postgres -c "psql -d veo3web -f /root/old_db.sql"
    """
