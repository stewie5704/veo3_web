...
"""
    with open('lowercase_db.py', 'w') as f:
        f.write(script)
    run_ssh_command("cat << 'EOF' > /opt/veo3-web/backend/lowercase_db.py\n" + script + "\nEOF")
    run_ssh_command("cd /opt/veo3-web/backend && python3 lowercase_db.py")
