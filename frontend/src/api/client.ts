...
export const authApi = {
  ...
  verifyEmail: (code: string) => api.post('/auth/verify-email', { code }).then(r => r.data),
...
export const projectsApi = {
  ...
  insertScene: (id: string, index: number, part: number = 1) => 
    api.post(`/projects/${id}/scenes/insert`, { index, part }).then(r => r.data),
  ...
  extractOutline: (projectId: string, parse_mode: boolean = true) =>
    api.post(`/projects/${projectId}/extract-outline`, { parse_mode }).then(r => r.data),
